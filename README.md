...
1) Algorithm Complexity: It's fairly critical that you understand big-O complexity analysis. Again
run some practice problems to get this down in application. <br>
2) Sorting: Know how to sort. Don't do bubble-sort. You should know the details of at least one
n*log(n) sorting algorithm, preferably two (say, quicksort and merge sort). Merge sort can be
highly useful in situations where quicksort is impractical, so take a look at it. <br>
3) Hashtables: Arguably the single most important data structure known to mankind. You absolutely
should know how they work. Be able to implement one using only arrays in your favorite
language, in about the space of one interview. <br>
4) Trees: Know about trees; basic tree construction, traversal and manipulation algorithms. 
...
between inorder, postorder and preorder. <br>
5) Graphs: Graphs are really important. There are 3 basic ways to represent a graph in
...
algorithms, such as Dijkstra and A*. <br>
6) Other data structures: You should study up on as many other data structures and algorithms as
...
interviewer asks you them in disguise. Find out what NP-complete means. <br>
...
more the better. <br>
8) Operating Systems: Know about processes, threads and concurrency issues. Know about locks
...
know the fundamentals of "modern" concurrency constructs. <br>
9) Coding: You should know at least one programming language really well, and it should
